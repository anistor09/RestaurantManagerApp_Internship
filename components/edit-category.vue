			...
			<div id='add-Category-Info' class="bottom">
				<ClientOnly>
					...
					<Teleport to="body">
						...
						<el-dialog v-model="addSubcategoryPopUp" id='add_subcategory_popup' width="25%" style="border-radius: 5%; height: 65%"
							...
							<div class="edit" style="padding-left: 3%;">
								...
								<div data-testid="subcategory-description-title" style="padding-top: 2%">
									...
									<div class="div" style="display: flex; align-items: center; padding-bottom: 1%;">
										<div  id="subcategory-description" style="width: 30%; padding-bottom: 0.9%;">Description: </div>

										<el-button class="aiButtonSubcatgory" @click="addAiSubcategoryDescription">✨Write with AI</el-button>

									</div>

									<textarea id="subcategory-description-input" data-testid="subcategory-description-input" v-model="newSubcategoryDescription"
					...
					<div class="elementLeft">
						<div class="box">
							...
							<div class="div" style="display: flex; align-items: center;">
								<div id="category-description" class="fieldText" style="width: 20%; padding-bottom: 0.9%;">Description</div>

								<el-button class="aiButton" @click="addAiCategoryDescription">✨Write with AI</el-button>

							</div>
							<textarea id="input-category-description" v-model="description" class="specialTextArea"></textarea>
						</div>
					</div>
